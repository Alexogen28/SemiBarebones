    ...
    const glm::mat4 &transformation)
{
    ...
    //reprezinta pasul 1 din transformarea perspectiva
    //realizarea vectorul:
    //x', y', z', w' vector
    ...
    //aplicare pas 2 -- impartire perspectiva
    //x'/w', y'/w', z'/w'

    glm::vec3 coordinates_2 = glm::vec3
    (
        homogenous_coordinate.x / homogenous_coordinate.w, homogenous_coordinate.y / homogenous_coordinate.w, homogenous_coordinate.z / homogenous_coordinate.z
    );

    //glm::vec3 clip_space_pos = glm::vec3(coordinates_2);
