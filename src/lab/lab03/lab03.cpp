...
void Lab03::DrawShapes()
{
    ...
    vector<VertexFormat> vertices
    {
         ...
         VertexFormat(glm::vec3(0.5, 0,  0.5), glm::vec3(1, 1, 0)),
         VertexFormat(glm::vec3(0, 1.5,  0.5), glm::vec3(1, 0, 1)),
    };
...

    {
        ...
        transformation *= viewPortTransformation;
        transformation *= transform2D::Translate(8, 6);
        transformation *= transform2D::Rotate(1.25664);
...

    {
        ...
        transformation *= viewPortTransformation;
        transformation *= transform2D::Translate(8, 6);
        transformation *= transform2D::Rotate(2.51327);
...

    {
        ...
        transformation *= viewPortTransformation;
        transformation *= transform2D::Translate(8, 6);
        transformation *= transform2D::Rotate(3.76991);
    ...
    }
    {
        ...
        transformation *= viewPortTransformation;
        transformation *= transform2D::Translate(8, 6);
        transformation *= transform2D::Rotate(5.02655);
   ...
   //     float pi = 3.14;
   //     float radians = 45 * (pi / 180);
   //     transformation *= transform2D::Rotate(radians);
