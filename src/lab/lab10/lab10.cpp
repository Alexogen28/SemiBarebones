...
void Lab10::Init()
{
    ...
    LoadShader("ShaderTriangle", "WorldSpace", "Color", "Triangle");
    LoadShader("ShadersTask4", "WorldSpace", "Texture", "LabShaderTask4");
    LoadShader("ShadersTask5", "WorldSpace", "Color", "LabShaderTask5");
}
...
void Lab10::Update(float deltaTimeSeconds)
{
    ...
    //task3
    {
        ...
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5));
        RenderSimpleMesh(meshes["triangle"], shaders["ShaderTriangle"], modelMatrix);
    }
    ...
    //task4
    {
        ...
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.01));
        RenderSimpleMesh(meshes["archer"], shaders["ShadersTask4"], modelMatrix, mapTextures["archer"]);
    }
    ...
    //task 5
    {
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(2, 0, 2));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.01));
        RenderSimpleMesh(meshes["archer"], shaders["ShadersTask5"], modelMatrix, mapTextures["archer"]);
    }
}
...
void Lab10::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, Texture2D* texture)
{
    ...
    float loc_time = glGetUniformLocation(shader->program, "Time");
